...
# start
dict_answer = dict()
for answer in range(123, 9877):
    str_a = str(answer)
    if len(str_a) == 3:
        str_a = "0" + str_a
    if str_a[0] == str_a[1] or str_a[0] == str_a[2] or str_a[0] == str_a[3] or str_a[1] == str_a[2] or str_a[1] == str_a[3] or str_a[2] == str_a[3]:
        continue
    print(answer, ":", end=" ")
    count = 0
    numlist = []
